...
function resolveBundleType(bundleType, version, injectProfilingHooks) {
...
export function getRendererInfo({ rendererPackageName, version, bundleType, injectProfilingHooks, }) {
...
export function isUnsupportedRenderer(renderer) {

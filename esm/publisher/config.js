...
function normOpenSourceLoc(value) {
    ...
    pattern, projectRoot = "", basedir = "", basedirJsx = null, } = typeof value === "string" ? { pattern: value } : value;
...
if (typeof document !== "undefined") {
    ...
    if (typeof rawConfig === "string") {
        try {
            ...
            const parsedOpenSourceSettings = normOpenSourceLoc(parsedConfig.openSourceLoc);
            config = {
                ...parsedConfig,
            ...
            console.error(`[React Render Tracker] Config parse error\nConfig: ${rawConfig}\n`, error);
        }
    }
}

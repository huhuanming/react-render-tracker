import { CONTEXT_SYMBOL_STRING, FORWARD_REF_SYMBOL_STRING, FRAGMENT_SYMBOL_STRING, LAZY_SYMBOL_STRING, MEMO_SYMBOL_STRING, PROVIDER_SYMBOL_STRING, } from "./constants";
...
// }
export function getDisplayNameFromJsx(type) {
    if (type) {
        switch (typeof type) {
            case "string":
                return type;

export function createReactInteractionApi({ ReactTypeOfWork, getFiberIdThrows, getFiberById, getElementTypeForFiber, getDisplayNameForFiber, getRootPseudoKey, shouldFilterFiber, findFiberByHostInstance, }) {
